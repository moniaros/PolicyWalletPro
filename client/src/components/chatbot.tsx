...
export function Chatbot() {
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      id: "1",
      role: "bot",
      content: "Hi Alex! I'm your PolicyGuard AI assistant. I can help you check your coverage, file a claim, or find an agent. How can I help you today?",
      timestamp: new Date(),
    },
  ]);
  ...
  const generateResponse = (text: string): string => {
    ...
    if (lower.includes("car") || lower.includes("auto") || lower.includes("accident")) {
    ...
    if (lower.includes("pet") || lower.includes("dog") || lower.includes("max")) {
          ...
          >
            ...
            <div className="bg-primary p-4 flex items-center justify-between text-primary-foreground">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="font-bold text-sm">PolicyGuard AI</h3>
